...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, phone, password, passwordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"newClass.js":[function(require,module,exports) {
"use strict";
...
var newClass = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, venue, term, day, time, time1, duration, startDate, endDate, age, age1, maxCapacity, description, fullPrice, classPrice) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                ...
                term: term,
                day: day,
                time: "".concat(time, " - ").concat(time1),
                duration: duration,
                startDate: startDate,
                endDate: endDate,
                age: "".concat(age, " - ").concat(age1),
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Class created successfully!');
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
  ...
  return function newClass(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14, _x15) {
    return _ref.apply(this, arguments);
  };
}();
...
exports.updateClassSettings = exports.deleteClass = exports.updateSettings = void 0;
...
var deleteClass = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            spath = path.split('/');
            id = spath[spath.length - 1];
            _context2.prev = 3;
            _context2.next = 6;
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://127.0.0.1:3000/api/v1/classes/".concat(id),
              data: data
            });
          ...
          case 6:
            ...
            (0, _alerts.showAlert)('success', 'Class deleted successfully!');
            window.setTimeout(function () {
  ...
  return function deleteClass(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
...
var updateClassSettings = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(name, venue, term, day, time, time1, duration, startDate, endDate, age, age1, maxCapacity, description, fullPrice, classPrice) {
    var path, spath, id, res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 6:
            ...
            if (res.data.status === 'success') {
              console.log(res.data);
              (0, _alerts.showAlert)('success', 'Class updated successfully!');
              window.setTimeout(function () {
                location.assign('/manage-classes');
              }, 1500);
            }
  ...
  return function updateClassSettings(_x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14, _x15, _x16, _x17, _x18, _x19) {
    return _ref3.apply(this, arguments);
  };
}();

exports.updateClassSettings = updateClassSettings;
...
var _newClass = require("./newClass");
...
var newClassForm = document.querySelector('.newClass-form');
var updateClassForm = document.querySelector('.form-update-class');
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _signup.signup)(name, email, phone, password, passwordConfirm);
  });
}
...
if (newClassForm) {
  newClassForm.addEventListener('submit', function (e) {
    ...
    (0, _newClass.newClass)(name, venue, term, day, time, time1, duration, startDate, endDate, age, age1, maxCapacity, description, fullPrice, classPrice);
  });
}
...
if (updateClassForm) {
  updateClassForm.addEventListener('submit', function (e) {
    ...
    var fullPrice = document.getElementById('fullPrice').value;
    var classPrice = document.getElementById('classPrice').value;
    (0, _updateSettings.updateClassSettings)(name, venue, term, day, time, time1, duration, startDate, endDate, age, age1, maxCapacity, description, fullPrice, classPrice);
  });
}
